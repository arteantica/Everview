...
public final class EverviewDebugHud {
    ...
    private static void extractRenderState(GuiGraphicsExtractor graphics, DeltaTracker deltaTracker) {
        ...
        lines.add("Everview M3.7.4.1 | LOADED-CHUNK OWNERSHIP");
        lines.add("26.3 Fabric | Sodium " + yesNo(sodium) + " | Iris " + yesNo(iris));
        lines.add("Handoff: L1/L2 clipped only where vanilla chunks are actually loaded");
        lines.add("LOD bands: inner64 -> 1b | next64 -> 2b | missing vanilla keeps LOD fallback");
